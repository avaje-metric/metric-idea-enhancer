...
public class ToggleEbeanAction extends ToggleAction {
  ...
  public boolean isSelected(AnActionEvent e) {
    ...
    if (currentProject != null && currentProject.hasComponent(MetricsActionComponent.class)) {
      final MetricsActionComponent action = currentProject.getComponent(MetricsActionComponent.class);
